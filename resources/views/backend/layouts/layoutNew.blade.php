...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/immigration/admin/css/applicant.css" />
    <link rel="stylesheet" type="text/css" href="/immigration/admin/bootstrap-5.3.1-dist/css/bootstrap.css" />
...
<body data-loader="{{url('/loading.gif')}}">
<div class="main">
...
<script type="text/javascript" src="/immigration/admin/bootstrap-5.3.1-dist/js/bootstrap.bundle.js"></script>
...
<script>var colors = ['#007bff','#28a745','#333333','#c3e6cb','#dc3545','#6c757d'];

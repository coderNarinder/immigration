...
<div class="row px-3 pt-4  mt-5 profile">
    <div class="col-11">
        <h2 class="">Add Service Type</h2>
    </div>
    <div class="col-1 text-center">
        <a href="{{route('admin.ServiceType.index')}}" class="btn btn-success" style="float:right;"><svg
                    ...
                    <div class="row mt-4">
                        <h5>Service Type</h5>
                         <div class="col-lg-4 col-12 mb-3">
                            <input type="text" class="form-control" name="name" id="name" placeholder="Service Type">
                        </div> 
                    </div> 
                </div>
            </div>

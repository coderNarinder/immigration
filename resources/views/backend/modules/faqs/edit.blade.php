...
<div class="row px-3 pt-4  mt-5 profile">
    <div class="col-11">
        <h2 class="">Edit FAQs</h2>
    </div>
    <div class="col-1 text-center">
        <a href="{{route('admin.FAQs.index')}}" class="btn btn-success" style="float:right;"><svg
                    ...
                    <div class="row mt-4"> 
                         ...
                         <div class="col-6 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="faq_category_id" required>
                                   ...
                                   <option value="{{$c->id}}" {{$c->id == $data->faq_category_id ? 'selected' : ''}}>{{$c->name}}</option>
                                   @endforeach
                                </select>
                            </div> 
                         </div>
                         ...
                         <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$data->question}}" name="question" id="question" required>
                            </div> 
                         </div>
                         ...
                         <div class="col-12 mb-3">
                            <div class="form-group">
                                <label>Answer</label>
                                <textarea class="form-control" name="answer" id="answer" required>{{$data->answer}}</textarea>
                            </div> 
                         </div>

...
<div class="row px-3 pt-4  mt-5 profile">
    <div class="col-11">
        <h2 class="">Edit Designation</h2>
    </div>
    <div class="col-1 text-center">
        <a href="{{route('admin.Designation.index')}}" class="btn btn-success" style="float:right;"><svg
...
<div class="row p-4">
    <div class="shadow">
        ...
        <form class="form-edit-category" name="addCategory" role="form" method="post"  
         id="categoryForm" 
         data-action="{{route('admin.Designation.edit',$data->id)}}"

...
<div class="wrapper-shadow-inset">
  ...
  data-action="{{ route('admin.email.edit',$data->slug) }}"
  enctype="multipart/form-data">
   @csrf
     @include('admin.error_message')
    <div class="row">
        <div class="col-md-12">   
             {{textbox($errors,'Email Title*','title',$data->title)}}
        </div>
        <div class="col-md-12">  
             {{textbox($errors,'Subject*','subject_line',$data->subject)}}
        </div>
        <div class="col-md-12">  
             <div class="form-group">
                  <label>Email Content<span class="mandatory">*</span></label>
                  <textarea class="form-control" placeholder="Enter Email Content" rows="4" name="subject" id="subject">{!!$data->content!!}</textarea>

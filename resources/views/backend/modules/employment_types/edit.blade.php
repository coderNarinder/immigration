...
<div class="row px-3 pt-4  mt-5 profile">
    <div class="col-11">
        <h2 class="">Edit Employment Type</h2>
    </div>
    <div class="col-1 text-center">
        <a href="{{route('admin.EmploymentType.index')}}" class="btn btn-success" style="float:right;"><svg
                ...
                <title>View Employment Type</title>
            </svg>
        </a>
    </div>
</div>
<div class="row p-4">
    <div class="shadow">
        ...
        <form class="form-edit-category" name="addCategory" role="form" method="post"  
         id="categoryForm" 
         data-action="{{route('admin.EmploymentType.edit',$data->id)}}"

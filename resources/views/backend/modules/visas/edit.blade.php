                    ...
                    <div class="row mt-4">
                         ...
                         <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="visa_type_id" required>
                                   <option value="">Choose</option>
                                   @foreach($visaTypes as $v)
                                   <option value="{{$v->id}}" {{$v->id == $data->visa_type_id ? 'selected' : ''}}>{{$v->name}}</option>
                                   @endforeach
                                </select>
                            </div> 
                         </div> 
                         ...
                         <div class="col-6 mb-3">
                            <div class="form-group">
                                <label>Fee</label>
                                <input type="number" class="form-control"  value="{{$data->fee}}" name="fee" id="fee" required>
                            </div> 
                         </div> 
                         ...
                         <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="overview" id="overview" required><?=$data->overview?></textarea>
                            </div> 
                         </div>  
                    </div> 
                </div>

...
<div class="row px-3 pt-4  mt-5 profile">
    ...
    <div class="col-1 text-center">
        <a href="{{route('admin.Location.index')}}" class="btn btn-success" style="float:right;"><svg
                    ...
                    <div class="row mt-4">
                         ...
                         <div class="col-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$data->phone_number}}" name="phone_number" id="phone_number" required>
                            </div> 
                         </div> 
                         <div class="col-6 mb-3">
                            <div class="form-group">
                                <label>Contact Person</label>
                                <input type="text" class="form-control" value="{{$data->contact_person}}" name="contact_person" id="contact_number" required>
                            </div> 
                         </div>
                         <div class="col-6 mb-3">
                            <div class="form-group">
                                <label>Branch Name</label>
                                <input type="text" class="form-control" value="{{$data->branch_name}}" name="branch_name" id="branch_name" required>
                            </div> 
                         </div>
                         <div class="col-6 mb-3">
                            <div class="form-group">
                                <label>Address</label>
                                <input type="text" class="form-control" value="{{$data->address}}" name="address" id="address" required>
                            </div> 
                         </div>    
                    </div> 
                </div>

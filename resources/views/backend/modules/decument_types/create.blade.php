...
<div class="row px-3 pt-4  mt-5 profile">
    <div class="col-11">
        <h2 class="">Add Document Type</h2>
    </div>
    <div class="col-1 text-center">
        <a href="{{route('admin.DocumentType.index')}}" class="btn btn-success" style="float:right;"><svg
                    ...
                    <div class="row mt-4">
                        <h5>Document Type</h5>
                         <div class="col-lg-4 col-12 mb-3">
                            <input type="text" class="form-control" name="name" id="name" placeholder="Document Type">
                        </div> 
                    </div> 
                </div>
            </div>

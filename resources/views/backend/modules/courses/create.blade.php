                ...
                <div class="tab ">  
                    <div class="row mt-4"> 
                         ...
                         <div class="col-6 mb-3">
                            <div class="form-group">
                                <label>Min GPA</label>
                                <input type="text" class="form-control" name="min_gpa" id="min_gpa" required>
                            </div> 
                         </div>
                         ...
                         <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="exam_requirements" id="exam_requirements" required></textarea>
                         ...
                         <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="other_details" id="other_details" required></textarea> 
                            </div> 
                         </div>
                    </div> 
                </div>

 ...
 jQuery("form[name=addCategory]").validate({
    ...
    var dataTable = $('#example2').DataTable({
        ...
        columns: [
              ...
              { data: 'logo', name: 'logo',searchable:false,"bSortable": false, render: function ( data, type, row ){

                      $text  ='<div class="logo">';
                      $text +='<img src="'+data+'" style="width:120px;">';
                      $text +='</div>';
                      return $text;
                 }
             }, 
             { data: 'name', name: 'name',"bSortable":true},
             { data: 'desc', name: 'desc',searchable:false,"bSortable":true},

$(function() { 
 ...
 jQuery("form[name=addYoutube]").validate({
    rules: {
       'title': 
        {
            required: true,
 ...
 jQuery("form[name=addCategory]").validate({
  ...
  var dataTable = $('#example2').DataTable({
        ...
        columns: [
             ...
             { data: 'contact_number', name: 'contact_number',"bSortable": true},
             { data: 'NameOfBrandTMProtectedElement', name: 'NameOfBrandTMProtectedElement',"bSortable": false},
             { data: 'CopyrightedDescLink', name: 'CopyrightedDescLink',"bSortable": false},
             { data: 'remarks', name: 'remarks',"bSortable": false},
             { data: 'product_url', name: 'product_url',"bSortable": false},

...
<div class="text-center col-lg-5 signbg">
...
<form class="mx-4">
<div class="row">
<h3 class="pt-4 mb-4 pb-4 text-center">Create <span class="span">An Account</span></h3>
...
<div class="row">
  ...
  <input type="number" class="form-control" placeholder="Mobile No." aria-label="mobile no." aria-describedby="basic-addon1" required>
</div>
</div>
...
<div class="row">
  ...
  <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zM5 8h6a1 1 0 0 1 1 1v5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1z"/>
   ...
   <input type="passsword" class="form-control" id="password" name="password" placeholder="Confirm Password" value="">
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
			 ...
			 <div class="d-flex justify-content-center"><button type="submit" class="more mb-4">SIGN UP</button></div>
			<div class="d-flex justify-content-center">
			<div class="pb-4">Already have an account? <a href="login.php" class="create">Login here</a></div>
			</div>
        </div>		

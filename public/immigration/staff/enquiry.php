...
<div class="col-11"><h2 class="">Add Enquiry</h2></div>
<div class="col-1 text-center">

<a href="view_enquiry.php" class="btn btn-success" style="float:right;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye " viewBox="0 0 16 16">

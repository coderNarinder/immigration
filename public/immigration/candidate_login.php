...
<h5 class="bb">Candidate <span class="red">Login</span></h5>
<form>
            <div class="mb-3 mt-5">
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
			...
			<div>New to Pijjen? <a href="signup.php" class="create">Create an account</a></div><div><a href="forgot_pass.php" class="forgot">Forgot password?</a></div>
			</div>
        </form>
